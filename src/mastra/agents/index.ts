...
// Trading assistant instructions shared across agents
...
/**
 * Build the configuration object for Agent constructors
 */
export function buildAgentConfig(memory: Memory) {
  return {
    ...
    tools: {
      ...
      "change-instrument-type": changeInstrumentTypeTool,
...
export function createChatAgent(memory?: Memory): Agent {
  ...
  return new Agent(buildAgentConfig(memory));
}
