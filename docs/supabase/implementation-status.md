...
- **エントリー機能テスト** (`__tests__/unit/supabase-entry.test.ts`)
  - ✅ ユーザーのエントリー取得機能
  - ✅ エントリー作成機能
  - ✅ エントリー更新機能
  - ✅ エントリー削除機能
...
- **メモリ機能テスト** (`__tests__/unit/supabase-memory.test.ts`)
  - ✅ メモリの作成/更新/削除機能
  - ✅ ユーザーのメモリ取得機能
  - ✅ テキスト検索機能
  - ✅ ベクトル類似度検索機能
...
- **チャット機能テスト** (`__tests__/unit/supabase-chat.test.ts`)
  - ✅ チャットメッセージの取得/作成/更新/削除機能
  - ✅ 画像アップロード機能
  - ✅ リアルタイム購読機能（チャットメッセージと会話メッセージ）

- **設定機能テスト** (`__tests__/unit/supabase-settings.test.ts`)
  - ✅ ユーザー設定の取得/更新機能
  - ✅ チャート設定の管理機能
  - ✅ シンボル設定の管理機能
...
# 特定のファイルのテストのみ実行（例：エントリー機能のテスト）
npm test -- __tests__/unit/supabase-entry.test.ts
...
2. **機能カバレッジの拡大**
   - 設定機能の異常系（エラーケース）のテスト強化が必要
   - API連携部分のテスト強化が必要

3. **E2Eテストの実装**
   - フロントエンド連携を含めたエンドツーエンドテストが未実装 